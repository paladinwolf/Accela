var sql = "Update bpd Set bpd.B1_SHORT_NOTES = 'Fermented Malt Beverage and Wine Retailer' FROM B1PERMIT b1p Inner Join BCHCKBOX bcb on b1p.B1_PER_ID1 = bcb.B1_PER_ID1 \
 ...
 and b1p.B1_PER_ID2 = bpd.B1_PER_ID2 and b1p.B1_PER_ID3 = bpd.B1_PER_ID3 and b1p.SERV_PROV_CODE = bpd.SERV_PROV_CODE Where bcb.B1_CHECKBOX_DESC = 'Type of License' \
 and bcb.B1_CHECKLIST_COMMENT = 'Fermented Malt Beverage and Wine Retailer' and b1p.B1_APPL_STATUS not in ('Closed', 'Defunct') and b1p.SERV_PROV_CODE = 'COSPRINGS'";
